...
class LangJA {
        ...
        public static function contents(){
                $response = array('ImportUpdate' => 'インポート/更新',
                        ...
                        'MetaBoxRelationFields' => 'MetaBox 関連フィールド',
                        ...
                        'JetEngineRFFields' => 'ジェットエンジンのRFフィールド',
                        'JetEngineCPTFields' => 'ジェットエンジンのCPTフィールド',
                        'JetEngineCPTRFFields' => 'ジェットエンジンCPTRFフィールド',
                        'JetEngineCCTFields' => 'ジェットエンジンCCTフィールド',
                        'JetEngineCCTRFFields' => 'ジェットエンジンCCTRFフィールド',
                        'JetEngineTaxonomyFields' => 'ジェットエンジンの分類フィールド',
                        'JetEngineTaxonomyRFFields' => 'ジェットエンジン分類法RFフィールド',
                        'JetEngineRelationsFields' => 'ジェットエンジン関係フィールド',
                        ...
                        'elementorfields'=>'Elementorフィールド',
                        'License'=>'ライセンス',
                        'ThankYouForYourPurchase'=>'ご購入いただきありがとうございます',
                        'ToGetStartedYouNeedToActivateByEnteringTheLicensekey'=>'開始するには、ライセンスキーを入力してアクティブ化する必要があります',
                        'EnterTheLicenseKey'=>'ライセンスキーを入力してください',
