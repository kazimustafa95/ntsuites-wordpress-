...
class JetEngineExtension extends ExtensionHandler{
	...
	*/
	...
	public function JetEngineRFFields($import_type){
		...
		$import_type = $this->import_post_types($import_type);
		global $wpdb;	
		$get_meta_fields = $wpdb->get_results("SELECT option_value FROM {$wpdb->prefix}options WHERE option_name = 'jet_engine_meta_boxes'");
	...
	*/
	...
	function import_post_types($import_type, $importAs = null) {	
		...
		$module = array('Posts' => 'post', 'Pages' => 'page', 'Users' => 'user', 'Comments' => 'comments', 'Taxonomies' => $importAs, 'CustomPosts' => $importAs);
