...
class WPCF7R_Action {
	 ...
	 *
	 * @param [string] - $key - the lead id.
	 * @param [string] - $value - the lead id.
	 */
	 ...
	 *
	 * @param [any] $key - the lead id.
	 * @return [any] - the value of the global option.
	 */
	 ...
	 * @param string   $predefined_value - the default value.
	 *
	 * @return string;
	 */
