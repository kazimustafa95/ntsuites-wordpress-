jQuery(function($){
    ...
    var module = {
        ...
        'nodes': {
            'container': '.content_type_filter_container',
            'right': '#content_type_sortable',
            'left': '#content_type_draggable',
            'attributes': '.content_type_filter_attributes',
            'otherAttributes': '.content_type_filter_other_attributes',
            'label': '.content_type_filter_attributes input[attr="label.text"]',
            'remove': '.content_type_filter_remove'
        },
